...
public class Function {
    ...
    mappingInbox(String album, String path, String timestamp, String time, String count) {
    ...
    public static String getCount(Context c, String
            album_name) {
        Uri uriExternal =
        ...
        Cursor cursorExternal =
                c.getContentResolver().query(uriExternal, projection,
                        "bucket_display_name = \"" + album_name + "\"", null, null);
        Cursor cursorInternal =
                c.getContentResolver().query(uriInternal, projection,
                        "bucket_display_name = \"" + album_name + "\"", null, null);
    ...
    public static float convertDpToPixel(float dp, Context
            context) {
